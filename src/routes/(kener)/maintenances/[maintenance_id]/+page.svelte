...
<svelte:head>
  ...
  <meta property="og:image:alt" content={data.maintenance.title + " — " + (data.siteName || "Zirel")} />
  <meta name="twitter:image" content={ogImage} />
  <meta name="twitter:image:alt" content={data.maintenance.title + " — " + (data.siteName || "Zirel")} />
</svelte:head>
